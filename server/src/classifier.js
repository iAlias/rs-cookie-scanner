...
const KNOWN_COOKIES = [
  ...
  { pattern: /^_fbq$/i, category: 'marketing', provider: 'Facebook', description: 'Facebook Pixel: internal tracker.' },
  { pattern: /^_clck$/i, category: 'analytics', provider: 'Microsoft', description: 'Microsoft Clarity: persists the Clarity user ID.' },
  { pattern: /^_clsk$/i, category: 'analytics', provider: 'Microsoft', description: 'Microsoft Clarity: connects pageviews into a single session recording.' },
  { pattern: /^CLID$/i, category: 'analytics', provider: 'Microsoft', description: 'Microsoft Clarity: identifies the first-time Clarity saw this user.' },
  { pattern: /^ANONCHK$/i, category: 'analytics', provider: 'Microsoft', description: 'Microsoft Clarity: indicates whether MUID is transferred to ANID.' },
  { pattern: /^MR$/i, category: 'analytics', provider: 'Microsoft', description: 'Microsoft: used to collect information for analytics purposes.' },
  { pattern: /^SM$/i, category: 'analytics', provider: 'Microsoft', description: 'Microsoft: used in synchronizing the MUID across Microsoft domains.' },
  { pattern: /^MUID$/i, category: 'marketing', provider: 'Microsoft', description: 'Microsoft: widely used as a unique user identifier by Microsoft.' },
  ...
  { pattern: /^_tt_enable_cookie$/i, category: 'marketing', provider: 'TikTok', description: 'TikTok: checks whether cookies can be placed.' },
  { pattern: /^_ttp$/i, category: 'marketing', provider: 'TikTok', description: 'TikTok: tracks visitors across websites to display relevant ads.' },
  { pattern: /^li_sugr$/i, category: 'marketing', provider: 'LinkedIn', description: 'LinkedIn: collects data on user behaviour for advertising.' },
  { pattern: /^UserMatchHistory$/i, category: 'marketing', provider: 'LinkedIn', description: 'LinkedIn: ad delivery and retargeting.' },
  { pattern: /^bcookie$/i, category: 'marketing', provider: 'LinkedIn', description: 'LinkedIn: browser identifier cookie.' },
  { pattern: /^lidc$/i, category: 'necessary', provider: 'LinkedIn', description: 'LinkedIn: data center routing optimisation.' },
